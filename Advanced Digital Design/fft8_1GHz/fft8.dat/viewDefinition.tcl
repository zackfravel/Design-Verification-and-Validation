...
create_constraint_mode -name NG_con_typ\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/NG_con_typ/NG_con_typ.sdc]
create_analysis_view -name NG_view_typ -constraint_mode NG_con_typ -delay_corner NG_dc_typ -latency_file ${::IMEX::dataVar}/mmmc/views/NG_view_typ/latency.sdc
